class ProblemsToSolve {
    public static void main(String[] args) {
        System.out.println(new ProblemsToSolve().minNumber(new int[] {1, 2, 3}, 2));
        System.out.println(new ProblemsToSolve().minNumber(new int[] {1, 2, 3, 4, 5}, 4));
        System.out.println(new ProblemsToSolve().minNumber(new int[] {10, 1, 12, 101}, 100));
        System.out.println(new ProblemsToSolve().minNumber(new int[] {10, 1}, 9));
        System.out.println(new ProblemsToSolve().minNumber(new int[] {6, 2, 6, 2, 6, 3, 3, 3, 7}, 4));
    }
